...
final class ScaleBarModel: ObservableObject {
    ...
    static let ticks: [Double] = [1, 2, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 100]
    ...
    func updateOverlay(bounds: CGRect) {
        ...
        let path = CGPath( rect: CGRect(x: 0, y: 0, width: bounds.width, height: 60), transform: nil )
    ...
    func update(renderer: SCNSceneRenderer) {
        ...
        self.pt_to_meter = 1 / metersPerPt
